...
type StreamGeometry = StreamGeometry of string

module StreamGeometry =
    let toStreamGeometryString (StreamGeometry s) = s

let svgData = Map [
    (   // https://materialdesignicons.com/icon/amazon
        Alphanumeric "mdi_amazon_24px",
    ...
    (   // https://materialdesignicons.com/icon/human-female-dance
        Alphanumeric "mdi_bolero_dance_24px",
    ...
    (   // https://materialdesignicons.com/icon/link-variant
        Alphanumeric "mdi_link_variant_24px",
...
let svgNode (viewBox: string) (pathData: StreamGeometry) =
    svg
        ...
        [ RawHtml $@"<path d=""{pathData |> StreamGeometry.toStreamGeometryString}""></path>" ]
